...
import fr.cactuscata.pcmevent.utils.other.Reflection.PackageType;

/**
 * <a href="https://bukkit.org/threads/1-8-particleeffect-v1-7.154406">Lien de
 * la classe.</a>
 * 
 * @author DarkBladee12
 * @version 2.5.1
...
public enum ParticleEffect {
	...
	public final boolean hasProperty(ParticleProperty property) {
	...
	public static final ParticleEffect fromName(final String name) {
	...
	public static final ParticleEffect fromId(final int id) {
	...
	private static final boolean isWater(final Location location) {
	...
	private static final boolean isDataCorrect(final ParticleEffect effect, final ParticleData data) {
		return ((effect == BLOCK_CRACK || effect == BLOCK_DUST) && data instanceof BlockData)
				|| (effect == ITEM_CRACK && data instanceof ItemData);
	}

	private static final boolean isColorCorrect(final ParticleEffect effect, final ParticleColor color) {
	...
	public final void display(final float offsetX, final float offsetY, final float offsetZ, final float speed,
	...
	public final void display(final Vector direction, final float speed, final Location center, final double range)
			throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
		if (!isSupported()) {
			throw new ParticleVersionException("This particle effect is not supported by your server version");
		}
	...
	public final void display(final Vector direction, final float speed, final Location center,
	...
	public final void display(final Vector direction, final float speed, final Location center, final Player... players)
			throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
		display(direction, speed, center, Arrays.asList(players));
	}

	public final void display(final ParticleColor color, final Location center, final double range)
	...
	public final void display(final ParticleColor color, final Location center, final List<Player> players)
			throws ParticleVersionException, ParticleColorException {
		if (!isSupported()) {
			throw new ParticleVersionException("This particle effect is not supported by your server version");
		}
	...
	public final void display(final ParticleColor color, final Location center, final Player... players)
			throws ParticleVersionException, ParticleColorException {
		display(color, center, Arrays.asList(players));
	}

	public final void display(final ParticleData data, final float offsetX, final float offsetY, final float offsetZ,
	...
	public final void display(final ParticleData data, final Vector direction, final float speed, final Location center,
	...
	public final void display(final ParticleData data, final Vector direction, final float speed, final Location center,
			final List<Player> players) throws ParticleVersionException, ParticleDataException {
		if (!isSupported()) {
			throw new ParticleVersionException("This particle effect is not supported by your server version");
		}
		if (!hasProperty(ParticleProperty.REQUIRES_DATA)) {
	...
	public final void display(final ParticleData data, final Vector direction, final float speed, final Location center,
			final Player... players) throws ParticleVersionException, ParticleDataException {
	...
	public static abstract class ParticleData {
		...
		public final int[] getPacketData() {
			return packetData;
		}

		public final String getPacketDataString() {
	...
	public static final class ParticlePacket {
		...
		public ParticlePacket(final ParticleEffect effect, final float offsetX, final float offsetY,
				final float offsetZ, final float speed, final int amount, final boolean longDistance,
				final ParticleData data) throws IllegalArgumentException {
			initialize();
			if (speed < 0) {
		...
		public ParticlePacket(final ParticleEffect effect, final Vector direction, final float speed,
				final boolean longDistance, final ParticleData data) throws IllegalArgumentException {
		...
		public static final void initialize() throws VersionIncompatibleException {
			if (initialized) {
				return;
			}
			try {
		...
		private final void initializePacket(final Location center) throws PacketInstantiationException {
			if (packet != null) {
				return;
			}
			try {
				...
				if (version < 8) {
					...
					Reflection.setValue(packet, "a", enumParticle.getEnumConstants()[effect.getId()]);
					Reflection.setValue(packet, "j", longDistance);
					if (data != null) {
						int[] packetData = data.getPacketData();
						Reflection.setValue(packet, "k", effect == ParticleEffect.ITEM_CRACK ? packetData
								: new int[] { packetData[0] | (packetData[1] << 12) });
					}
				}
				Reflection.setValue(packet, "b", (float) center.getX());
				Reflection.setValue(packet, "c", (float) center.getY());
				Reflection.setValue(packet, "d", (float) center.getZ());
				...
				Reflection.setValue(packet, "i", amount);
			} catch (Exception exception) {
				throw new PacketInstantiationException("Packet instantiation failed", exception);
			}
		}

		public final void sendTo(final Location center, final Player player)
		...
		public final void sendTo(final Location center, final List<Player> players) throws IllegalArgumentException {
			if (players.isEmpty()) {
		...
		public final void sendTo(final Location center, final double range) throws IllegalArgumentException {
			if (range < 1) {
				throw new IllegalArgumentException("The range is lower than 1");
			}
			final String worldName = center.getWorld().getName();
			double squared = Maths.square(range);
